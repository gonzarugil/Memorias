...
\Large
DOBLE GRADO EN \\ ING. INFORMÁTICA + ING. DEL SOFTWARE
...
\LARGE
ANÁLISIS DE EMOCIONES EN CANALES RSS

\vspace{4cm}

\large
Autor : Gonzalo Ruanes Gil \\
...
\vspace{1cm}
\large
\textbf{Autor :} Gonzalo Ruanes Gil \\
\textbf{Tutor :} Isaac Martín de Diego
...
\vspace{1cm}
\begin{flushright}
Móstoles, a \qquad$\;\,$ de \qquad\qquad\qquad\qquad de 20XX
\end{flushright}
...
\section{Python} 
\label{sec:estadodelarte1}

\section{PyCharm} 
\label{sec:estadodelarte2}

\section{RSS} 
\label{sec:estadodelarte3}

\section{Jupyter Notebook} 
\label{sec:estadodelarte4}

\section{Matplotlib} 
\label{sec:estadodelarte5}

\section{Scikit Learn} 
\label{sec:estadodelarte6}
...
\subsection{Módulo 1}
\label{subsec:modulo1}

\subsection{Módulo 2}
\label{subsec:modulo2}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RESULTADOS %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
